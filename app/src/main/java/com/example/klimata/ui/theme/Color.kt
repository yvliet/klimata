...
val PowerGreenActive = Color(0xFF22C55E)
val CarbonBlue = Color(0xFF0284C7)
val SavingsYellow = Color(0xFFFACC15)
val SavingsYellowLight = Color(0xFFFDE047)
val SavingsYellowDark = Color(0xFFEAB308)
...
// Minimalist OLED Black Detail Tokens
