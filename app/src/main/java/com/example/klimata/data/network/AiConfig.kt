...
object AiConfig {
    ...
    const val PRIMARY_MODEL: String = "gemini-flash-lite-latest"
    const val SECONDARY_MODEL: String = "gemini-flash-latest"
    const val TERTIARY_MODEL: String = "gemini-3.8-flash"
