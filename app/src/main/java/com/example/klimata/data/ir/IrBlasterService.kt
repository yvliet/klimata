...
class IrBlasterService(private val context: Context) {
    ...
    private fun buildGreePulses(bytes: IntArray): IntArray {
        ...
        for (i in 0..3) {
            ...
            for (bit in 0 until 8) {
                ...
                array[idx++] = if (isOne) oneSpace else zeroSpace
            }
        }
    ...
    private fun buildPulses(
        ...
        val array = IntArray(4 + data.size * 16)
        var idx = 0
        array[idx++] = headerMark
        array[idx++] = headerSpace
        ...
        array[idx++] = stopMark
        array[idx++] = 40000 // 40ms inter-message lead-out silence
        return array
    }
