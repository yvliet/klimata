...
object RoomFactory {
    ...
    fun createRoom(
        ...
        val resolvedEnergy = energyConfig ?: EnergyConfig.resolveForLocation(cityName = location)
    ...
    fun resolveDefaultCodeSet(brand: String, modelCode: String?): String {
        ...
        return when {
            cleanBrand.contains("sharp") -> when {
                m.contains("ucy") || m.contains("say") || m.contains("turbo") || m.contains("yb0f") || m.contains("bey") -> "sharp_gree_oem"
